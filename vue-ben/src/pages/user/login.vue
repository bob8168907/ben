  ...
  <div class="login-body">
    <div class="loginWarp"
      ...
      <div class="login-title">
        <img src="./images/login_logo.png" height="100px" width="100px" />
      </div>
      <div class="login-form">
        <el-form ref="form" :model="form" :rules="rules" label-width="0">
          <el-form-item prop="qq" class="login-item">
            <el-input v-model="form.qq" placeholder="请输入账户名：" class="form-input" :autofocus="true"></el-input>
          </el-form-item>
  ...
  export default{
    data(){
      return {
        ...
        rules: {
          qq: [{required: true, message: '请输入账户名！', trigger: 'blur'}],
